...
void UF_uArm::record(unsigned char buttonPin, unsigned char buttonPinC)
{
  ...
  while(digitalRead(buttonPin))
  {
     ...
     // Serial.println("uarm.servoBufOutL(leftServoLast, " + String(leftServo) + ");");
     // Serial.println("uarm.servoBufOutL(rightServoLast, " + String(rightServo) + ");");
     // Serial.println("uarm.servoBufOutL(rotServoLast, " + String(rotServo) + ");");
     // Serial.println("leftServoLast = leftServo; rightServoLast = rightServo; rotServoLast = rotServo; delay(d);");
     // Serial.println("");
